...
$solutionNameArg = "/property:SolutionName=../src/LifxNet.sln"

$allArgs = @("LifxNet.proj", "/m$maxCpuCountText", "/nologo", "/verbosity:$verbosity", "/t:$target", "/property:RequestedVerbosity=$verbosity", $solutionNameArg, $args)
& $msbuild $allArgs
